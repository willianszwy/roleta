...
export const enUS: Translation = {
  ...
  'tasks.participantsLabel': 'People',
  ...
  'tasks.pendingCount': '{{count}} pending{{plural}}',
  'tasks.completedCount': '{{count}} completed{{plural}}',
  ...
  'modal.save': 'Save',
  'modal.delete': 'Delete',
  'modal.removeParticipant': 'Remove Participant',
  'modal.clearHistory': 'Clear History',
  'modal.clearParticipants': 'Clear Participants',
  'modal.removeTask': 'Remove Task',
  'modal.clearTasks': 'Clear Tasks',
  'modal.clearTaskHistory': 'Clear Task History',
  'modal.export': 'Export',
  'modal.noDataToExport': 'No data to export!',
  'modal.remove': 'Remove',
  'modal.clear': 'Clear',
  'modal.ok': 'OK',
